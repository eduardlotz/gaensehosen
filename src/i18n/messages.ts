...
const messages = {
  de: {
    brand: "Gänsehosen",
    search: "Nach Zitat oder Person suchen",
    ...
    exportTitle: "Zitate exportieren",
    exportIntro: "Lade deine Sammlung als JSON oder CSV herunter.",
    exportJson: "JSON exportieren",
    exportCsv: "CSV exportieren",
    importCsv: "CSV importieren",
    importQuotes: "Zitate importieren",
  ...
  en: {
    ...
    exportTitle: "Export quotes",
    exportIntro: "Download your collection as JSON or CSV.",
